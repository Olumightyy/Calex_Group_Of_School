...
const students = [
  { id: 1, name: "John Smith", email: "john@school.edu", grade: "10A", status: "active" },
  { id: 2, name: "Sarah Johnson", email: "sarah@school.edu", grade: "10B", status: "active" },
  { id: 3, name: "Mike Davis", email: "mike@school.edu", grade: "9A", status: "active" },
  { id: 4, name: "Emma Wilson", email: "emma@school.edu", grade: "11A", status: "inactive" },
  { id: 5, name: "Alex Brown", email: "alex@school.edu", grade: "10A", status: "active" },
]
